  ...
  function O(a, e) {
    ...
    return `<!DOCTYPE html>
        ...
        * { background-color: #171717; color: white;  font-family: "Be Vietnam Pro", sans-serif;}
        ...
        <li>Contacting The Ghost Network Developer Team <a href="https://discord.gg/dbyDXfs5dN" target="_blank">discord.gg/dbyDXfs5dN</a></li>
        <li>Verify the wisp server isn't censored</li>
        </ul>
        <p>If you're the administrator of <b id="uvHostname"></b>, try:</p>
        <ul>
        <li>Restarting your server</li>
        <li>Updating <a href="https://github.com/titaniumnetwork-dev/Ultraviolet" target="_blank">Ultraviolet</a></li>
        <li>Troubleshooting the error on the <a href="https://github.com/The-Ghost-Network" target="_blank">GitHub repository</a></li>
        </ul>
        <button id="reload" style="color: white; border-radius: 5px;">Reload</button>
        <hr />
        <p><i>Ultraviolet v<span id="uvVersion"></span></i> || Ghost v2.3.1</p>
